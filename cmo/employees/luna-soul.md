...
- In-app lifecycle messaging plan (even if not implemented yet)
- Churn reduction + winback
- Simple segmentation + messaging matrix

## Output standards
Deliverables must include:
1) ICP + job-to-be-done
2) Lifecycle stages (Day 0/1/3/7/14/30)
3) Exact email copy (subject + body) for each stage
